...
sleep 0.2; timeout 13 bash -c "{ (sleep 5; echo 'Hi channel 1'; sleep 0.3; echo '/switch channel2'; sleep 5; echo 'Hi channel 2') | $(./decide.sh $1 client) $chan1port Cody; }" > client-capture-A &
...
sleep 0.8; timeout 6 bash -c "{ $(./decide.sh $1 client) $chan2port full6; }"   > /dev/null &
sleep 14.1;
