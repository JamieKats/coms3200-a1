...
sleep 0.3; timeout 2.1 bash -c "{ (sleep 0.5; echo 'A day may come when I am muted'; sleep 0.9; echo 'But it is not this day') | $(./decide.sh $1 client) $chan1port Jono; }"    > client-capture &
sleep 2.6;
