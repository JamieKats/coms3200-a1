...
sleep 0.3; timeout 2 bash -c "{ (sleep 0.75; echo -e '/send Bob ./testtmp/AsFile.txt'; sleep 0.75; echo -e '/send ReceiverThree ./testtmp/AsFile.txt') | $(./decide.sh $1 client) $chan1port SenderThree; }" > client-capture-B &
sleep 3.1;
