...
sleep 0.2; timeout 2.5 bash -c "{ (sleep 1; echo 'I am in channel 1'; sleep 0.3; echo '/switch channel2'; sleep 0.3; echo 'I am in channel 2') | $(./decide.sh $1 client) $chan1port Alex; }" > client-capture-A &
