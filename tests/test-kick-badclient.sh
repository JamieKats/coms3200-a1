...
timeout 1 bash -c "{ (sleep 0.5;) | $(./decide.sh $1 client) 2351 Joseph; }" > client-capture-A &
timeout 1 bash -c "{ (sleep 0.5; ) | $(./decide.sh $1 client) 1240 Donald; }" > client-capture-B &
timeout 1 bash -c "{ (sleep 0.5;) | $(./decide.sh $1 client) 1240 Joe; }" > client-capture-C ;
